...
**`All`**` = 0`
: The status of an issue does not matter
...
**`AddIssueNotes`**` = 1`
: 	Allowed to add notes to issues

**`AddIssues`**` = 2`
: Allowed to add issues

**`AddProjects`**` = 3`
: Allowed to add projects

**`DeleteIssues`**` = 4`
: Allowed to delete issues
...
**`EditOwnIssues`**` = 7`
: Allowed to edit own issues

**`EditProjects`**` = 8`
: Allowed to edit projects

**`ManageIssueRelations`**` = 9`
: Allowed to edit issue relations issues

**`ManageMembers`**` = 10`
: Allowed to edit project members

**`ManageSubtasks`**` = 11`
: Allowed to edit subtasks

**`SelectProjectModules`**` = 12`
: Allowed to select project modules

**`SetIssuesPrivate`**` = 13`
: Allowed to set issues private state

**`SetOwnIssuesPrivate`**` = 14`
: Allowed to set own issues private state

**`Unknown`**` = 0`
: Database default value but should never happen
...
**`Active`**` = 1`
: [User](#type-user) can login and use their account

**`Anonymous`**` = 0`
: Database default value but should never happen

**`Locked`**` = 3`
: [User](#type-user) was once active and is now locked, [User](#type-user) can not login

**`Registered`**` = 2`
: [User](#type-user) has registered but not yet confirmed their email address or was not yet activated by an administrator, User can not login
...
**`searchable:`** [`bool`](#type-bool)
: Adds a searchbar, defaults to false

**`value:`** [`T`](#type-t) (*readonly*)
: Selected element
...
: Filename of the [Attachment](#type-attachment)

**`filesize:`** [`int32`](#type-int32) (*readonly*)
: Filesize of the [Attachment](#type-attachment) in Bytes
...
: Attachments of the [Issue](#type-issue)
...
: Updated date of the [Issue](#type-issue)
...
**`active:`** [`bool`](#type-bool)
: Active state of the [IssuePriority](#type-issuepriority)
...
**`createdOn:`** [`date`](#type-date) (*readonly*)
: Creation date of the [Project](#type-project)
...
: Flag if the [Project](#type-project) should inherit members

**`isPublic:`** [`bool`](#type-bool)
: Is public state of the [Project](#type-project)

**`issueCategories:`** `[`[`IssueCategory`](#type-issuecategory)`]` (*readonly*)
: [Issue](#type-issue) categories of the [Project](#type-project)
...
: [Modules](#type-projectmodule) of the [Project](#type-project)
...
**`issue:`** [`Issue`](#type-issue) (*required*)
: [Issue](#type.issue) which relates to the containing issue
...
: [Attachments](#type-attachment) which shall be deleted
...
**`memberships:`** `[`[`Membership`](#type-membership)`]`
: [Memberships](#type-membership) to remove
...
: [Projects](#type-project) to remove
...
: Permissions of the [Role](#type-role)
...
**`addUsers:`** `[`[`User`](#type-user)`]`
: Users to be added to the [Group](#type-group), can not be set if 'users' is set

**`group:`** [`Group`](#type-group) (*required*)
: [Group](#type-group) to update

**`name:`** [`string`](#type-string)
: Name of the [Group](#type-group)

**`removeUsers:`** `[`[`User`](#type-user)`]`
: Users to be removed from the [Group](#type-group), can not be set if 'users' is set

**`users:`** `[`[`User`](#type-user)`]`
: Users of the [Group](#type-group), can not be set if 'addUsers' or 'removeUsers' is set
...
**`addRoles:`** `[`[`Role`](#type-role)`]`
: Roles to be added to the [Membership](#type-membership), can not be set if 'roles' is set

**`membership:`** [`Membership`](#type-membership) (*required*)
: [Membership](#type-membership) to update

**`removeRoles:`** `[`[`Role`](#type-role)`]`
: Roles to be removed of the [Membership](#type-membership), can not be set if 'roles' is set

**`roles:`** `[`[`Role`](#type-role)`]`
: Roles of the [Membership](#type-membership), can not be set if 'addRoles' or 'removeRoles' is set
...
**`addCustomModules:`** `[`[`string`](#type-string)`]`
: Custom modules to be added to the [Project](#type-project), can not be set if 'customModules' is set

**`addStandardModules:`** `[`[`ProjectModule`](#type-projectmodule)`]`
: Standard modules to be added to the [Project](#type-project), can not be set if 'standardModules' is set
...
**`inheritMembers:`** [`bool`](#type-bool)
: Inherit members state of the [Project](#type-project)
...
: [Project](#type-project) to update

**`removeCustomModules:`** `[`[`string`](#type-string)`]`
: Custom modules to be removed of the [Project](#type-project), can not be set if 'customModules' is set

**`removeStandardModules:`** `[`[`ProjectModule`](#type-projectmodule)`]`
: Standard modules to be removed of the [Project](#type-project), can not be set if 'standardModules' is set

**`standardModules:`** `[`[`ProjectModule`](#type-projectmodule)`]`
: [Modules](#type-projectmodule) of the [Project](#type-project), can not be set if 'addStandardModules' or 'removeCustomModules' is set
...
**`isAdmin:`** [`bool`](#type-bool)
: Is admin state of the [User](#type-user)

**`lastname:`** [`string`](#type-string)
: Lastname of the [User](#type-user)

**`login:`** [`string`](#type-string)
: Login of the [User](#type-user)

**`mail:`** [`string`](#type-string)
: Mail of the [User](#type-user)

**`status:`** [`UserStatus`](#type-userstatus)
: [UserStatus](#type-userstatus) of the [User](#type-user)

**`user:`** [`User`](#type-user) (*required*)
: [User](#type-user) to update
...
#### Parameters
**`id:`** [`int32`](#type-int32)
: Redmine id of issue category to return
...
#### Parameters
**`name:`** [`string`](#type-string)
: Name of issue status to return
...
: Redmine id of project to return
...
#### Parameters
**`id:`** [`int32`](#type-int32)
: Redmine id of group in project to return
...
#### Parameters
**`name:`** [`string`](#type-string)
: Group name of group in project to return
...
#### Parameters
**`project:`** [`Project`](#type-project)
: Project from which the groups are retrieved
...
#### Parameters
**`project:`** [`Project`](#type-project)
: Project from which the issue categories are retrieved
...
#### Parameters
**`name:`** [`string`](#type-string)
: Name of issue category to return

**`project:`** [`Project`](#type-project)
: Project from which the issue category is retrieved
...
: [Group](#type-group) of which the membership is to be returned
...
**`user:`** [`User`](#type-user)
: [User](#type-user) of which the membership is to be returned
...
#### Parameters
**`project:`** [`Project`](#type-project)
: Project from which the user is retrieved

**`login:`** [`string`](#type-string)
: Redmine login of user to return
...
#### Parameters
**`project:`** [`Project`](#type-project)
: Project from which the users are retrieved
